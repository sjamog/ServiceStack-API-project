...
namespace WebApplication4
{
    public class Global : System.Web.HttpApplication
    {
        ...
        {
            public HelloAppHost() : base("The simple car db", typeof (HelloService).Assembly)
            {
            }

            public override void Configure(Funq.Container container)
            {
                base.Container.Adapter = new WindsorContainerAdapter();
                ...
                Plugins.Add(new AuthFeature(() => new AuthUserSession(),
                    new IAuthProvider[] { new BasicAuthProvider(), new CredentialsAuthProvider(new AppSettings())}));
